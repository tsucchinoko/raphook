...
cp target/aarch64-apple-darwin/release/raphook packages/npm/raphook/bin/
cp target/aarch64-apple-darwin/release/raphook packages/npm/raphook-darwin-arm64/bin/
